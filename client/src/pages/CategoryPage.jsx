...
const TripCard = ({ trip }) => {
  ...
  const imgSrc = trip.image || trip.gallery?.[0]?.src;
      ...
      <div className="max-w-7xl mx-auto px-3 md:px-6">
        ...
        <div className="mb-5 md:mb-8">
          ...
          <h1 className="text-2xl md:text-4xl font-extrabold text-gray-900 leading-tight">
            {label} <span className="text-blue-600">Exploration</span>
          </h1>
        ...
        {displayTrips.length === 0 && (
          <div className="text-center py-20 text-gray-400">
            ...
            <p className="font-semibold text-sm">No trips found in this category yet.</p>
            <Link to="/" className="text-blue-600 text-xs font-bold mt-2 inline-block hover:underline">
              ← Back to Home
            </Link>
          </div>
        )}
