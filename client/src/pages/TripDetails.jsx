...
const TripDetails = () => {
  ...
  /* PRICE LOGIC */
  const getPrice = () => {
    if (!currentTrip.occupancy) return currentTrip.price;
    if (selectedPrice === "quad") return currentTrip.occupancy.quad;
    if (selectedPrice === "triple") return currentTrip.occupancy.triple;
    if (selectedPrice === "double") return currentTrip.occupancy.double;
    return currentTrip.price;
  };
