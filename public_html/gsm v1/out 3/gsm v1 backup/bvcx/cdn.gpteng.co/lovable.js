...
var hr = () => {
  ...
  bt = (() => {
    let e = !1,
      t = ({ message: r, lineno: o, colno: n, filename: i, error: l }) => ({
        message: r,
        lineno: o,
        colno: n,
        filename: i,
    ...
    return () => {
      ...
      let n = (l) =>
        ...
        i = (l) => {
          ...
          if (n(a)) return;
          let s = t(l);
          D({ type: "RUNTIME_ERROR", error: { ...s, blankScreen: gr() } });
        };
...
function le(e, t = {}, r = new WeakMap(), o = "root") {
  ...
  return (
    ...
    l.length > n.maxObjectKeys &&
      ((a = l.length - n.maxObjectKeys), (i["..."] = `${a} more properties`)),
    i
  );
}
  ...
  vt = (() => {
    let e = !1,
      ...
      n = () => {
        ...
        let i = [...t];
        (t.length = 0), (r = null), D({ type: "CONSOLE_OUTPUT", messages: i });
      };
    return () => {
      if (e) return;
      let i = (l) => {
...
`));
          ...
          let c = a.map((m) =>
              le(m, { maxDepth: 5, includeSymbols: !0, preserveTypes: !0 })
            ),
            d =
              c
                .map((m) =>
                  typeof m == "string"
                    ? m
                    : JSON.stringify(m, null, 2).slice(0, 1e4)
                )
                .join(" ") +
              (s
                ? `
...
var Lt = (function () {
  ...
  return (
    (e.prototype.getId = function (t) {
      var r;
      if (!t) return -1;
      var o = (r = this.getMeta(t)) === null || r === void 0 ? void 0 : r.id;
      return o ?? -1;
    }),
...
function Gr(e, t) {
  ...
  switch (e.nodeType) {
    ...
    case e.COMMENT_NODE:
      return { type: Y.Comment, textContent: e.textContent || "", rootId: R };
    default:
      return !1;
  }
}
...
function Pr(e, t) {
  ...
  if (c && s) {
    try {
      ...
      console.warn(
        "Cannot get CSS styles from text's parentNode. Error: ".concat(f),
        e
      );
    }
    s = xe(s, it());
  ...
  return (
    ...
    !c && !d && s && at(e, o, n) && (s = i ? i(s) : s.replace(/[\S]/g, "*")),
  ...
  if (I === "img" && f) {
    ...
    var L = function () {
      try {
        ...
        console.warn(
          "Cannot inline img src=".concat(E.currentSrc, "! Error: ").concat(re)
        );
      }
  ...
  if (e.type === Y.Element) {
    ...
    if (
      ...
      ((e.tagName === "link" && e.attributes.rel === "shortcut icon") ||
        (e.tagName === "meta" &&
          (F(e.attributes.name).match(/^msapplication-tile(image|color)$/) ||
  ...
  if ((H.type === Y.Document || H.type === Y.Element) && ne) {
    ...
    if (Sr(e) && e.shadowRoot)
      for (
        ...
        var $ = O[oe],
          _ = pe($, Ce);
        _ && (me(e.shadowRoot) && (_.isShadow = !0), H.childNodes.push(_));
      }
  }
  return (
    e.parentNode && ge(e.parentNode) && me(e.parentNode) && (H.isShadow = !0),
    H.type === Y.Element &&
      H.tagName === "iframe" &&
      Wr(
        e,
  ...
  return function (...i) {
    ...
    a <= 0 || a > t
      ...
      : !o &&
        r.trailing !== !1 &&
        (o = setTimeout(() => {
          (n = r.leading === !1 ? 0 : Date.now()), (o = null), e.apply(s, i);
        }, a));
  };
}
      ...
      (this.frozen = !1),
        ...
        (this.emit = () => {
          ...
          let t = [],
            ...
            n = (a) => {
              ...
              let p = !this.doc.contains(a) && (!g || !this.doc.contains(g));
              ...
              let T = pe(a, {
                ...
                onSerialize: (I) => {
                  Be(I, this.mirror) && this.iframeManager.addIframe(I),
                    Ge(I, this.mirror) &&
                      this.stylesheetManager.trackLinkElement(I),
                    He(a) &&
                ...
                onIframeLoad: (I, y) => {
                  this.iframeManager.attachIframe(I, y),
                    this.shadowDomManager.observeAttachShadow(I);
                },
                onStylesheetLoad: (I, y) => {
                  this.stylesheetManager.attachLinkElement(I, y);
                },
              });
          ...
          for (let a of Array.from(this.addedSet.values()))
            (!_t(this.droppedSet, a) && !Ft(this.removes, a, this.mirror)) ||
            _t(this.movedSet, a)
              ? n(a)
          ...
          if (!We(t.target, this.mirror))
            switch (t.type) {
              case "characterData": {
                ...
                !B(t.target, this.blockClass, this.blockSelector, !1) &&
                  r !== t.oldValue &&
                  this.texts.push({
                    value:
              ...
              case "attributes": {
                ...
                if (
                  ...
                  return;
                let n = this.attributes.find((i) => i.node === t.target);
                if (
                  r.tagName === "IFRAME" &&
                  t.attributeName === "src" &&
              ...
              case "childList": {
                if (B(t.target, this.blockClass, this.blockSelector, !0))
                  return;
                    ...
                    B(t.target, this.blockClass, this.blockSelector, !1) ||
                      ...
                      (this.addedSet.has(r)
                        ...
                        : (this.addedSet.has(t.target) && o === -1) ||
                          ...
                          (this.movedSet.has(r) && this.movedMap[Dt(o, n)]
                            ? ut(this.movedSet, r)
                            : this.removes.push({
                                parentId: n,
                                id: o,
        ...
        (this.genAdds = (t, r) => {
          if (this.mirror.hasNode(t)) {
            ...
            this.movedSet.add(t);
            let o = null;
            r && this.mirror.hasNode(r) && (o = this.mirror.getId(r)),
              o &&
                o !== -1 &&
                (this.movedMap[Dt(this.mirror.getId(t), o)] = !0);
...
function Kr({ mousemoveCb: e, sampling: t, doc: r, mirror: o }) {
  ...
  let n = typeof t.mousemove == "number" ? t.mousemove : 50,
    ...
    c = Ee(
      (f) => {
        let m = ke(f),
          { clientX: g, clientY: p } = ct(f) ? f.changedTouches[0] : f;
        a || (a = Date.now()),
          l.push({ x: g, y: p, id: o.getId(m), timeOffset: Date.now() - a }),
          s(
...
function Qr({
  ...
  function d(T) {
    ...
    R === "radio" &&
      K &&
      U &&
      t.querySelectorAll(`input[type="radio"][name="${K}"]`).forEach((x) => {
        x !== I &&
          f(x, Gt({ text: x.value, isChecked: !U, userTriggered: !1 }, c));
      });
  }
  function f(T, I) {
    let y = Ht.get(T);
    ...
    Object.entries(s).forEach(([d, f]) => {
      (c[d] = {
        ...
        (f.prototype.deleteRule = function (m) {
          ...
          return (
            ((g && g !== -1) || (p && p !== -1)) &&
              e({ id: g, styleId: p, removes: [{ index: [...Ve(this), m] }] }),
...
function Xr({
  ...
  let i = (a) =>
      Ee((s) => {
        ...
        let { currentTime: d, volume: f, muted: m, playbackRate: g } = c;
        e({
          type: a,
          id: o.getId(c),
          currentTime: d,
          ...
          case N.Mutation:
            return (
              r.data.adds.forEach((n) => {
                this.replaceIds(n, t, ["parentId", "nextId", "previousId"]),
...
var Ke = class {
  ...
  observeAttachShadow(t) {
    if (t.contentWindow) {
      let r = this;
      this.restorePatches.push(
        ie(t.contentWindow.HTMLElement.prototype, "attachShadow", function (o) {
          return function (n) {
            let i = o.call(this, n);
            return (
              this.shadowRoot &&
...
function gt(e, t, r) {
  ...
  try {
    let n = ie(e.HTMLCanvasElement.prototype, "getContext", function (i) {
      return function (l, ...a) {
        return (
          B(this, t, r, !0) || "__context" in this || (this.__context = l),
          i.apply(this, [l, ...a])
        );
      };
    });
...
function $t(e, t, r, o, n) {
  let i = [];
  return (
    i.push(...Xt(t.WebGLRenderingContext.prototype, ce.WebGL, e, r, o, n, t)),
    typeof t.WebGL2RenderingContext < "u" &&
      i.push(
        ...Xt(t.WebGL2RenderingContext.prototype, ce.WebGL2, e, r, o, n, t)
      ),
    () => {
      i.forEach((l) => l());
    }
            ...
            args: [
              {
                ...
                args: [
                  {
                    rr_type: "Blob",
                    data: [{ rr_type: "ArrayBuffer", base64: k }],
                    type: T,
                  },
                ],
              },
        ...
        (d = p),
          m().forEach((S) =>
            Yt(this, void 0, void 0, function* () {
              ...
              if (a.get(T)) return;
              if ((a.set(T, !0), ["webgl", "webgl2"].includes(S.__context))) {
                let y = S.getContext(S.__context);
                ((k = y?.getContextAttributes()) === null || k === void 0
                  ? void 0
...
function Ie(e = {}) {
  ...
  let L,
    W = 0,
    V = (w) => {
      for (let q of j || []) q.eventProcessor && (w = q.eventProcessor(w));
      return k && (w = k(w)), w;
    };
  G = (w, q) => {
    var $;
    if (
      (!(($ = fe[0]) === null || $ === void 0) &&
        ...
        !(w.type === M.IncrementalSnapshot && w.data.source === N.Mutation) &&
  ...
  je = (w = !1) => {
    ...
    G(
            ...
            left:
              window.pageXOffset !== void 0
                ...
                : document?.documentElement.scrollLeft ||
                  (($ =
                    (q = document?.body) === null || q === void 0
                      ? void 0
                      : q.parentElement) === null || $ === void 0
                    ? void 0
                    : $.scrollLeft) ||
            ...
            top:
              window.pageYOffset !== void 0
                ...
                : document?.documentElement.scrollTop ||
                  ((O =
                    (oe = document?.body) === null || oe === void 0
                      ? void 0
                      : oe.parentElement) === null || O === void 0
                    ? void 0
                    : O.scrollTop) ||
      ...
      document.adoptedStyleSheets &&
        ...
        ne.adoptStyleSheets(document.adoptedStyleSheets, se.getId(document));
  };
  try {
    let w = [];
    w.push(
      ...
      return Kt(
        {
          ...
          mouseInteractionCb: (O) =>
            G(
              Z({
                type: M.IncrementalSnapshot,
                data: Object.assign({ source: N.MouseInteraction }, O),
              })
            ),
          scrollCb: re,
          viewportResizeCb: (O) =>
            G(
              Z({
                type: M.IncrementalSnapshot,
                data: Object.assign({ source: N.ViewportResize }, O),
              })
            ),
          inputCb: (O) =>
            G(
          ...
          mediaInteractionCb: (O) =>
            G(
              Z({
                type: M.IncrementalSnapshot,
                data: Object.assign({ source: N.MediaInteraction }, O),
              })
            ),
          styleSheetRuleCb: (O) =>
            G(
              Z({
                type: M.IncrementalSnapshot,
                data: Object.assign({ source: N.StyleSheetRule }, O),
              })
            ),
          styleDeclarationCb: (O) =>
            G(
              Z({
                type: M.IncrementalSnapshot,
                data: Object.assign({ source: N.StyleDeclaration }, O),
              })
            ),
          canvasMutationCb: de,
          fontCb: (O) =>
          ...
          plugins:
            ((oe = j?.filter((O) => O.observer)) === null || oe === void 0
              ? void 0
              : oe.map((O) => ({
                  observer: O.observer,
                  options: O.options,
...
var Re = (e) =>
  ...
  Oe = (e) => {
    let t = e.getAttribute("data-lov-id") || "",
      ...
      a = Array.from(e.children)
        ...
        .filter(
          (s, c, d) =>
            c === d.findIndex((f) => te(f).filePath === te(s).filePath)
        )
        .map((s) => ({
  ...
  pr = () => {
    ...
    let o = () => {
      ...
      i = (u, C) => {
        if (!(!u || !C))
          try {
            ...
            if (((u.style.maxWidth = `${b.MAX_TOOLTIP_WIDTH}px`), E))
            ...
            console.error("Error updating selected tooltip:", v), u.remove();
          }
      },
      l = (u) => {
        if (!(!t.tooltip || !u))
          try {
            ...
            if (((t.tooltip.style.maxWidth = `${b.MAX_TOOLTIP_WIDTH}px`), h))
              (t.tooltip.style.left = b.FULL_WIDTH_TOOLTIP_OFFSET),
                (t.tooltip.style.top = b.FULL_WIDTH_TOOLTIP_OFFSET);
            else {
      ...
      a = (u) => {
        let C =
          Math.abs(u.getBoundingClientRect().width - window.innerWidth) < 5;
      ...
      d = r((u) => {
        ...
        t.hoveredElement &&
          ...
          (t.hoveredElement && y(te(t.hoveredElement)))?.forEach((v) => {
            v.classList.contains("gpt-selected-element") || a(v);
          }),
          l(t.hoveredElement),
          t.tooltip &&
      ...
      f = r(() => {
        t.isActive &&
          (t.hoveredElement &&
            ((t.hoveredElement && y(te(t.hoveredElement)))?.forEach((C) => {
      ...
      y = (u) => {
        let C = `[data-lov-id="${u.filePath}:${u.lineNumber}:${u.col || "0"}"]`,
          ...
          switch (u.data.type) {
                      ...
                      document
                        ...
                        .forEach((h) => {
                          h.removeAttribute("disabled"),
                            h.setAttribute("data-lov-disabled", "");
                        });
                    }))
                  : (I(),
                    document
                      ...
                      .forEach((E) => {
                        E.removeAttribute("data-lov-disabled"),
                    ...
                    document
                      ...
                      .forEach((E) => {
                        E.hasAttribute(b.SELECTED_ATTR) ||
                          (s(E),
                          E instanceof HTMLElement && (E.style.cursor = ""));
                      }),
                    t.reset()));
              break;
            case "UPDATE_SELECTED_ELEMENTS":
              ...
              t.selectedTooltips.forEach((h) => h.remove()),
                t.selectedTooltips.clear(),
                document
                  .querySelectorAll(`[${b.SELECTED_ATTR}], [${b.HOVERED_ATTR}]`)
                  .forEach((h) => {
                    h.removeAttribute(b.SELECTED_ATTR),
                      h.removeAttribute(b.HOVERED_ATTR),
                      h.removeAttribute("data-full-width");
                  }),
                u.data.payload.forEach((h) => {
                  ...
                  A.forEach((V) => {
                    V.setAttribute(b.SELECTED_ATTR, "true"),
                      ...
                      ) < 5 && V.setAttribute("data-full-width", "true");
                  });
            ...
            case "SET_STYLESHEET": {
              let { stylesheet: h } = u.data.payload,
                E = document.getElementById(b.OVERRIDE_STYLESHEET_ID);
              if (E) E.innerHTML = h;
              else {
              ...
              y({
                ...
                let L = () => {
                    D({
                      ...
                      payload: { id: h, content: A.innerText },
                    });
                  },
                  W = () => {
                ...
                A.addEventListener("input", L), A.addEventListener("blur", W);
              });
              break;
            }
            case "HOVER_ELEMENT_REQUESTED": {
              let { id: h } = u.data.payload;
              document.querySelectorAll(`[${b.HOVERED_ATTR}]`).forEach((A) => {
            ...
            case "GET_PARENT_ELEMENT": {
              ...
              !L || L.id === "root" || ["HTML", "BODY"].includes(L.tagName)
        ...
        if (
          ...
          t.clickedElementMap.set(h, t.hoveredElement),
            ...
            Math.abs(v.width - window.innerWidth) < 5 &&
              t.hoveredElement.setAttribute("data-full-width", "true"),
            D({
