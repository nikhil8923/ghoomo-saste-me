                    ...
                    ?>
                            <tr>
                                ...
                                <td class='d-flex' style='gap:10px'>
                                    <a href="edit-host.php?id=<?= $row['id']; ?>" class="text-light badge badge-success">Edit</a>
                                    <a href="delete-host.php?id=<?= $row['id']; ?>" class="text-light badge badge-danger" onclick="return confirm('Are you sure you want to delete this host?')">Delete</a>
                                </td>
                            </tr>
                    <?php
                        }
